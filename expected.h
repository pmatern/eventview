...
/// discriminated union to hold value or 'error'.
            ...
            union storage_t {
                ...
                class nonstd::expected_lite::expected;
...
//  unexpected_type() = delete;
            ...
            constexpr explicit unexpected_type(unexpected_type<E2> const &error nsel_REQUIRES_A(
                    std::is_constructible<E, E2>::value
            ...
            template<typename E2>
            constexpr /*non-explicit*/ unexpected_type(unexpected_type<E2> const &error nsel_REQUIRES_A(
                    std::is_constructible<E, E2>::value
                    && !std::is_constructible<E, unexpected_type<E2> &>::value
                    && !std::is_constructible<E, unexpected_type<E2> >::value
                    && !std::is_constructible<E, unexpected_type<E2> const &>::value
            ...
            template<typename E2>
            constexpr explicit unexpected_type(unexpected_type<E2> &&error nsel_REQUIRES_A(
                    std::is_constructible<E, E2>::value
                    && !std::is_constructible<E, unexpected_type<E2> &>::value
                    && !std::is_constructible<E, unexpected_type<E2> >::value
                    && !std::is_constructible<E, unexpected_type<E2> const &>::value
            ...
            template<typename E2>
            constexpr /*non-explicit*/ unexpected_type(unexpected_type<E2> &&error nsel_REQUIRES_A(
                    std::is_constructible<E, E2>::value
                    && !std::is_constructible<E, unexpected_type<E2> &>::value
                    && !std::is_constructible<E, unexpected_type<E2> >::value
                    && !std::is_constructible<E, unexpected_type<E2> const &>::value
...
/// x.x.5 Specialized algorithms
        ...
        template<typename E nsel_REQUIRES_T(
                std17::is_swappable<E>::value
        )
        >
...
class expected
        ...
        public:
            ...
            nsel_constexpr14 expected(expected const &other nsel_REQUIRES_A(
            ...
            nsel_constexpr14 expected(expected &&other nsel_REQUIRES_A(
            ...
            nsel_constexpr14 explicit expected(expected<U, G> const &other nsel_REQUIRES_A(
            ...
            template<typename U, typename G>
            nsel_constexpr14 /*non-explicit*/ expected(expected<U, G> const &other nsel_REQUIRES_A(
                    std::is_constructible<T, U const &>::value
                    && std::is_constructible<E, G const &>::value
                    && !std::is_constructible<T, expected<U, G> &>::value
                    && !std::is_constructible<T, expected<U, G> &&>::value
            ...
            template<typename U, typename G>
            nsel_constexpr14 explicit expected(expected<U, G> &&other nsel_REQUIRES_A(
            ...
            template<typename U, typename G>
            nsel_constexpr14 /*non-explicit*/ expected(expected<U, G> &&other nsel_REQUIRES_A(
                    std::is_constructible<T, U>::value
                    && std::is_constructible<E, G>::value
                    && !std::is_constructible<T, expected<U, G> &>::value
                    && !std::is_constructible<T, expected<U, G> &&>::value
            ...
            nsel_constexpr14 expected(value_type const &value nsel_REQUIRES_A(
                    std::is_copy_constructible<T>::value)
            )
                    : has_value_(true) {
            ...
            nsel_constexpr14 explicit expected(U &&value nsel_REQUIRES_A(
                    std::is_constructible<T, U &&>::value
            ...
            template<typename U = T>
            nsel_constexpr14 /*non-explicit*/ expected(U &&value nsel_REQUIRES_A(
                    std::is_constructible<T, U &&>::value
                    && !std::is_same<typename std20::remove_cvref<U>::type, nonstd_lite_in_place_t(U)>::value
                    && !std::is_same<expected<T, E>, typename std20::remove_cvref<U>::type>::value
                    && !std::is_same<nonstd::unexpected_type<E>, typename std20::remove_cvref<U>::type>::value
            ...
            nsel_constexpr14 explicit expected(nonstd::unexpected_type<G> const &error nsel_REQUIRES_A(
                    std::is_constructible<E, G const &>::value
                    && !std::is_convertible<G const &, E>::value /*=> explicit */ )
            )
                    : has_value_(false) {
            ...
            template<typename G = E>
            nsel_constexpr14 /*non-explicit*/ expected(nonstd::unexpected_type<G> const &error nsel_REQUIRES_A(
                    std::is_constructible<E, G const &>::value
                    && std::is_convertible<G const &, E>::value /*=> non-explicit */ )
            )
                    : has_value_(false) {
            ...
            template<typename G = E>
            nsel_constexpr14 explicit expected(nonstd::unexpected_type<G> &&error nsel_REQUIRES_A(
                    std::is_constructible<E, G &&>::value
            ...
            template<typename G = E>
            nsel_constexpr14 /*non-explicit*/ expected(nonstd::unexpected_type<G> &&error nsel_REQUIRES_A(
                    std::is_constructible<E, G &&>::value
            ...
            template<typename G nsel_REQUIRES_T(
...
/// x.x.x Specialized algorithms
        ...
        template<typename T, typename E nsel_REQUIRES_T(
